...
void execute_pipe(char ** args){
    ...
    /* Check if any of the two commands is jash built in command */
    if(strcmp(args[0], "cd")==0 ||strcmp(args[0], "run")==0 ||strcmp(args[0], "exit")==0 ||strcmp(args[0], "parallel")==0 ||
            strcmp(args[1], "cd")==0 ||strcmp(args[1], "run")==0 ||strcmp(args[1], "exit")==0 ||strcmp(args[1], "parallel")==0){
        fprintf(stderr,"Error : built-in jash command given in pipe command\n");
        exit(0);
    }
